...
class CreateBtUsersTable extends Migration
{
    ...
    public function up()
    {
        ...
        Schema::create('bt_users', function (Blueprint $table) {
            ...
            $table->integer('user_type')->default(0)->comment('用户类型：0 普通，1 商家');
            $table->tinyInteger('user_status')->default(0)->comment('用户状态：0 正常，1 注销');
            ...
            $table->string('password', 1000)->comment('密码');
            ...
            $table->unsignedInteger('created_by')->nullable()->comment('创建人ID');
            $table->dateTime('created_at')->nullable()->comment('创建时间');
            $table->unsignedInteger('updated_by')->nullable()->comment('修改人ID');
